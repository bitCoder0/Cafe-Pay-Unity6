...
سلب مسئولیت
-----------
کد این پروژه برای من مفید بوده اما در سناریو های گوناگون و نسخه های گوناگون تست نشده و همچنین در حال حاضر در نسخه آزمایشی هست و ممکنه دارای ایراداتی باشه، همچنین توضیحات برگرفته از تجربه و برداشت شخصی هست،  بطور کل تلاش شده روش رفع مشکل و یک پروژه که خطایی نداره به شما ارائه بشه. فقط دوستان توجه داشته باشن که ترجیحا minify رو توی player settings فعال نکنن
