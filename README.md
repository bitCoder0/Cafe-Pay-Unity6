پرداخت درون برنامه ای بازار در Unity 6.2.6f2
----------------

درباره این پروژه
----------------
این پروژه یک نمونه آماده از پیاده سازی کتابخانه پولکی در یونیتی 6 میباشد که دو خطای مهم را به علت ناسازگاری/عدم بروزرسانی کتابخانه برای نسخه های جدید یونیتی رفع کند
...
- پروژه در مرحله آزمایشی قرار دارد.
- Minify را در Player Settings فعال نکنید.


سلب مسئولیت
-----------
کد در سناریو های گوناگون و نسخه های گوناگون تست نشده و همچنین در حال حاضر در نسخه آزمایشی میباشد و میتواند دارای ایراداتی باشد، همچنین توضیحات برگرفته از تجربه و برداشت شخصی میباشد،همچنین، به عنوان نکته پایانی توجه داشته باشید که ترجیحا تیک minify در player settings فعال نباشد.
برنامه‌های آتی
--------------
- تست مجدد پروژه
